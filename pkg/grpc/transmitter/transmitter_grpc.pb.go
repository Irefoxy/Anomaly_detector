...
const (
	Transmitter_ListRequests_FullMethodName = "/Transmitter/ListRequests"
)
...
type TransmitterClient interface {
	ListRequests(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Transmitter_ListRequestsClient, error)
}
...
func (c *transmitterClient) ListRequests(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Transmitter_ListRequestsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Transmitter_ServiceDesc.Streams[0], Transmitter_ListRequests_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type TransmitterServer interface {
	ListRequests(*Empty, Transmitter_ListRequestsServer) error
...
func (UnimplementedTransmitterServer) ListRequests(*Empty, Transmitter_ListRequestsServer) error {
